...
export type TLanguage = "jp" | "en" | "zh";
export const LANGUANGE_CONFIG: Record<TLanguage, string> = {
  zh: "中文",
  en: "英语",
  jp: "日语",
};
 ...
 * @returns
 */
export const transServe = async (
  str: string,
  toLangType: TLanguage = "en"
    ...
    try {
      ...
      request.get(url, (err, _, body) => {
        ...
        window.showErrorMessage(
          "翻译出错: " + body.error_code + "-" + body.error_msg
        );
      });
    } catch (error) {
